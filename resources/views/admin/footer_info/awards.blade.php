                    ...
                    <div class="section">
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    @if($errors->has('award_image'))
                                    <small class="small_form_error">{{$errors->first('award_image')}}</small>
                                    @endif                                    
                                    <div class="row">
                                        <div class="col-xs-8">
                                            <input type="text" name="award_image" class="form-control" readonly="true" id="award_image" value="{{old('award_image',$award_image)}}" />
                                        </div>
                                        <div class="col-xs-4">
                                            <button class="popup_selector btn btn-info" data-inputid="award_image" style="width:100%">Select Img</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    @if($errors->has('award_introduction'))
                                    <small class="small_form_error">{{$errors->first('award_introduction')}}</small>
                                    @endif
                                    <textarea name="award_introduction" id="award_introduction">{!! old('award_introduction',$award_introduction) !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Introduction(En)</label>
                                <div class="col-md-10">
                                    @if($errors->has('award_introduction_en'))
                                    <small class="small_form_error">{{$errors->first('award_introduction_en')}}</small>
                                    @endif
                                    <textarea name="award_introduction_en" id="award_introduction_en">{!! old('award_introduction_en',$award_introduction_en) !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
infoConfig['selector']='#award_introduction';
...
infoConfigEn['selector']='#award_introduction_en';
