                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="text" name="Colour" value="{{old('Colour',$colourInfo->Colour)}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="ColourEn" value="{{old('ColourEn',$colourInfo->ColourEn)}}" class="form-control" maxlength="40" />
                                </div>
                            </div>                            
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="number" name="OrderNumber" value="{{old('OrderNumber',$colourInfo->OrderNumber)}}" class="form-control" step="1" min="1" />
                                </div>
                            </div>                            
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="enabled" name="Status" value=1 {{intval(old('Status',$colourInfo->Status))===1?'checked=true':''}}>
                                                <label for="enabled">Yes</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="disabled" name="Status" value=0 {{intval(old('Status',$colourInfo->Status))===0?'checked=true':''}}>
