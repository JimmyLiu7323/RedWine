                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <input type="text" name="Image2" value="{{old('Image')}}" class="form-control" id="Image2" readonly="true" />
                                        </div>
                                        <div class="col-xs-4">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <input type="text" name="Image3" value="{{old('Image')}}" class="form-control" id="Image" readonly="true" />
                                        </div>
                                        <div class="col-xs-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input type="text" name="IntroductionPDF" value="{{old('IntroductionPDF')}}" class="form-control" id="IntroductionPDF" readonly="true" />
                                        </div>
                                        <div class="col-xs-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="text" name="NameEn" value="{{old('NameEn')}}" class="form-control" maxlength="255" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineCatg" class="form-control">
                                        <option {{old('WineCatg')==1?'selected=true':''}} value="1">REDS</option>
                                        <option {{old('WineCatg')==2?'selected=true':''}} value="2">WHITES</option>
                                        <option {{old('WineCatg')==3?'selected=true':''}} value="3">SPARKLING</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineStyle" class="form-control">
                                        ...
                                        <option value="{{$style->StyleId}}" {{old('WineStyle')==$style->StyleId?'selected=true':''}}>{{$style->Style}}</option>
                                        @endforeach
                                    </select>
                                </div>                                
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Cariety</label>
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineVariety" class="form-control">
                                        ...
                                        <option value="{{$variety->VarietyId}}" {{old('WineVariety')==$variety->VarietyId?'selected=true':''}}>{{$variety->Variety}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineColour" class="form-control">
                                        ...
                                        <option value="{{$colour->ColourId}}" {{old('WineColour')==$colour->ColourId?'selected=true':''}}>{{$colour->Colour}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineCountry" class="form-control">
                                        ...
                                        <option value="{{$countryKey}}" {{old('WineCountry')==$countryKey?'selected=true':''}}>{{$country}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineRegion" class="form-control">
                                        ...
                                        <option value="{{$region->RegionId}}" {{old('WineRegion')==$region->RegionId?'selected=true':''}}>{{$region->Region}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineClosure" class="form-control">
                                        ...
                                        <option value="{{$closure->ClosureId}}" {{old('WineClosure')==$closure->ClosureId?'selected=true':''}}>{{$closure->Closure}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="number" class="form-control" name="Volume" value="{{old('Volume',1)}}" step="1" min="1" />
                                </div>
                            </div> 
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="number" class="form-control" name="Alcohol" value="{{old('Alcohol',0.05)}}" step="0.01" min="0" />
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="WineCaterings[]" id="WineCaterings" class="form-control" multiple="multiple" maxselected=5>
                                        @foreach($caterings as $catering)
                                            @if(old('WineCaterings')=='')
                                            <option value='{{$catering->CateringId}}'>{{$catering->Catering}}</option>
                                            @else
                                            <option value='{{$catering->CateringId}}' {{in_array($catering->CateringId,old('WineCaterings'))?'selected=true':''}}>{{$catering->Catering}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <textarea name="DescriptionEn" class="form-control" id="DescriptionEn">{!! old('DescriptionEn') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="WeeklyReco_Y" name="WeeklyReco" value=1 {{old('WeeklyReco')!=''&&old('WeeklyReco')==1?'checked=true':''}}>
                                                <label for="WeeklyReco_Y">Yes</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="WeeklyReco_N" name="WeeklyReco" value=0 {{old('WeeklyReco')!=''&&old('WeeklyReco')==0?'checked=true':''}}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="Flagship_Y" name="Flagship" value=1 {{old('Flagship')!=''&&old('Flagship')==1?'checked=true':''}}>
                                                <label for="Flagship_Y">Yes</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="Flagship_N" name="Flagship" value=0 {{old('Flagship')!=''&&old('Flagship')==0?'checked=true':''}}>
