                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8">
                                            <input type="text" name="RegionMainImage" class="form-control" readonly="true" id="RegionMainImage" value="{{old('RegionMainImage')}}" />
                                        </div>
                                        <div class="col-xs-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="Region" value="{{old('Region')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="RegionEn" value="{{old('RegionEn')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <textarea class="form-control" name="RegionDesc" rows="3" style="resize:none">{!! old('RegionDesc') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <textarea class="form-control" name="RegionDescEn" rows="3" style="resize:none">{!! old('RegionDescEn') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
