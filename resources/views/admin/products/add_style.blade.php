                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8">
                                            <input type="text" name="StyleMainImage" class="form-control" readonly="true" id="StyleMainImage" value="{{old('StyleMainImage')}}" />
                                        </div>
                                        <div class="col-xs-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="Style" value="{{old('Style')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="StyleEn" value="{{old('StyleEn')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <textarea class="form-control" name="StyleDesc" rows="3" style="resize:none">{!! old('StyleDesc') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <textarea class="form-control" name="StyleDescEn" rows="3" style="resize:none">{!! old('StyleDescEn') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
