                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8">
                                            <input type="text" name="VarietyMainImage" class="form-control" readonly="true" id="VarietyMainImage" value="{{old('VarietyMainImage')}}" />
                                        </div>
                                        <div class="col-xs-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="Variety" value="{{old('Variety')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="VarietyEn" value="{{old('VarietyEn')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <textarea class="form-control" name="VarietyDesc" rows="3" style="resize:none">{!! old('VarietyDesc') !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <textarea class="form-control" name="VarietyDescEn" rows="3" style="resize:none">{!! old('VarietyDescEn') !!}</textarea>
                                </div>
                            </div>                                      
                            <div class="form-group">
