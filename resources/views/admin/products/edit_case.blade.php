                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8">
                                            <input type="text" name="CasePic" class="form-control" readonly="true" id="CasePic" value="{{old('CasePic',$caseInfo->CasePic)}}" />
                                        </div>
                                        <div class="col-xs-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="text" name="CaseName" value="{{old('CaseName',$caseInfo->CaseName)}}" class="form-control" maxlength="255" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="text" name="CaseNameEn" value="{{old('CaseNameEn',$caseInfo->CaseNameEn)}}" class="form-control" maxlength="255" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <textarea rows="4" style="resize:vertical" name="MetaDesc" class="form-control">{{old('MetaDesc',$caseInfo->MetaDesc)}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <textarea rows="4" style="resize:vertical" name="MetaDescEn" class="form-control">{{old('MetaDescEn',$caseInfo->MetaDescEn)}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="text" name="MetaKeywords" class="form-control" value="{{old('MetaKeywords',$caseInfo->MetaKeywords)}}" style="margin-bottom:0" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="text" name="MetaKeywordsEn" class="form-control" value="{{old('MetaKeywordsEn',$caseInfo->MetaKeywordsEn)}}" style="margin-bottom:0" />
                                    <span class="text-danger">(Use comma for split)</span>
                                </div>
                            </div>                                               
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <input type="number" name="OrderNumber" value="{{old('OrderNumber',$caseInfo->OrderNumber)}}" class="form-control" min=1 step=1 />
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="enabled" name="Status" value=1 {{old('Status',$caseInfo->Status)==1?'checked=true':''}}>
                                                <label for="enabled">Yes</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="radio radio-inline">
                                                <input type="radio" id="disabled" name="Status" value=0 {{old('Status',$caseInfo->Status)==0?'checked=true':''}}>
