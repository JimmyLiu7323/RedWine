                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="Closure" value="{{old('Closure')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="ClosureEn" value="{{old('ClosureEn')}}" class="form-control" maxlength="40" />
                                </div>
                            </div>
                            <div class="form-group">
