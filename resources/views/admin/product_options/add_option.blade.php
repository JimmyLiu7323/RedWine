                    ...
                    <div class="section">
                        <div class="section-body">
                            ...
                            <div id="productsInOption">
                                ...
                                @php
                                $oldWines=old('Wines',array());
                                $oldTopics=old('Topics',array());
                                @endphp
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <select name="Option" class="form-control" onchange="changeOption(this)">
                                        ...
                                        <option value="discount" {{old('Option')=='discount'?'selected=true':''}}>Discount with purchase of a target amount</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" id="purchaseAmount">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    @endif
                                    <input type="number" name="PurchaseAmount" class="form-control" value="{{old('PurchaseAmount')}}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="Price" value="{{old('Price')}}" min="0.1" step="0.1"/>
                                    </div>
                                </div>
                            </div>
                        </div>
