                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <select name="Department" class="form-control">
                                        <option value="0" {{old('Department',$accountInfo->Department)==''?'selected=true':''}}>無</option>
                                        @foreach($departments as $department)
                                        <option value="{{$department->DepartmentId}}" {{old('Department',$accountInfo->Department)==$department->DepartmentId?'selected=true':''}}>{{$department->Department}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="text" class="form-control" name="AdminName" value="{{old('AdminName',$accountInfo->AdminName)}}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="text" class="form-control" name="AdminAccount" value="{{old('AdminAccount',$accountInfo->AdminAccount)}}" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="text" class="form-control" name="email" value="{{old('email',$accountInfo->Email)}}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="text" class="form-control" name="phone" value="{{old('phone',$accountInfo->Phone)}}" />
                                </div>
                            </div>                            
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif                                    
                                    <input type="number" class="form-control" name="phone-ext" value={{old('phone-ext',$accountInfo->PhoneExt)}} />
                                </div>
                            </div>                            
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="0" {{intval(old('status',$accountInfo->Status))===0?'selected=true':''}}>否</option>
                                        <option value="1" {{intval(old('status',$accountInfo->Status))===1?'selected=true':''}}>是</option>
                                    </select>
                                </div>
                            </div>
                        </div>
