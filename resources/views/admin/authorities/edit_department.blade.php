                        ...
                        <div class="section-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="text" name="Department" class="form-control" value="{{old('Department',$departmentInfo->Department)}}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <input type="number" name="OrderNumber" class="form-control" value="{{old('OrderNumber',$departmentInfo->OrderNumber)}}" min="1" step="1" />
                                </div>
                            </div>
                        </div>
                    </div>
