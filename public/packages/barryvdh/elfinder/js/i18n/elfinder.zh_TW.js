...
(function(root, factory) {
	...
	elFinder.prototype.i18.zh_TW = {
		...
		messages   : {
			...
			'iconSize'        : 'Icon大小', // from v2.1.39 added 7.5.2018
			'columnPref'      : '欄位顯示 (列表)', // from v2.1.32 added 6.2.2018
			...
			'selectionInfo'   : '檔案/目錄資訊', // from v2.1.33 added 7.3.2018
			'makefileTypes'   : '新檔案允許的副檔名', // from v2.1.41 added 7.8.2018
			'typeOfTextfile'  : '請輸入副檔名', // from v2.1.41 added 7.8.2018
